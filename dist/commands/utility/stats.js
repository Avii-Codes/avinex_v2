...
const command = {
    ...
    async run(ctx) {
        ...
        const freeMemory = (os_1.default.freemem() / 1024 / 1024 / 1024).toFixed(2);
        const usedMemory = ((os_1.default.totalmem() - os_1.default.freemem()) / 1024 / 1024 / 1024).toFixed(2);
        const memoryPercent = (((os_1.default.totalmem() - os_1.default.freemem()) / os_1.default.totalmem()) * 100).toFixed(1);
        const systemUptime = formatUptime(os_1.default.uptime() * 1000);

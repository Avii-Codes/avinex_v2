...
const command = {
    name: 'moderator',
    description: 'Add a moderator role or user to this server',
    ...
    async run(ctx) {
        ...
        const container = new components_1.Container()
            .addText(`${emoji_1.Status.success} **Moderator Added**`)
            .addSeparator({ spacing: 'small', divider: true })
            .addText(`Added ${type} \`${id}\` as moderator for this server`);
